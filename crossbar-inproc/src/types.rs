...
//!
//! This module defines the data model that flows through the crossbar
...
///
/// ```rust
/// use crossbar_inproc::types::Method;
///
...
///
/// ```rust
/// use crossbar_inproc::types::{Method, Request};
///
...
///
/// ```rust
/// use crossbar_inproc::types::Response;
///
...
///
/// ```rust
/// use crossbar_inproc::types::{IntoResponse, Response};
///
/// struct NotFound;
...
///
/// ```rust
/// use crossbar_inproc::types::percent_decode;
...
///
/// ```rust
/// use crossbar_inproc::types::parse_query;
